...
- Google desktop OAuth foundation using PKCE, a loopback callback, DBus authorization signals, read-only calendar scope, and refresh-token storage in Secret Service.
